...
if (!uri) {
  console.error(
    "CRITICAL ERROR: MONGO_DB_URI is undefined in your environment variables.",
  );
  console.error(
    "Available env vars:",
...
async function connectToDatabase() {
  ...
  if (!uri) {
    throw new Error(
      "MongoDB URI is not defined. Please set MONGO_DB_URI or MONGODB_URI in environment variables.",
    );
  }
